...
{   
    ...
    private:
// TF buffer/listener (for looking up odom->camera_link)
std::shared_ptr<tf2_ros::Buffer> tf_buffer_;
std::shared_ptr<tf2_ros::TransformListener> tf_listener_;

// TF broadcaster (you may already have this)
...
// ---- SLAM outputs for RViz ----
rclcpp::Publisher<geometry_msgs::msg::PoseStamped>::SharedPtr pose_pub_;
rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr path_pub_;

nav_msgs::msg::Path path_msg_;

size_t max_path_len_ = 5000;

        // Class internal variables
        std::string homeDir = "";
        std::string packagePath = "ws_orbslam3/src/ros2_orb_slam3/"; //! Change to match path to your workspace
